...
case "$(uname -s)" in
    Darwin)
        ...
        echo "To check status: launchctl list $PLIST_NAME"
...
echo "Configuration file location: $SCRIPT_DIR/calendar_config.json"
echo "You can edit your calendar settings at any time by modifying this file or by using the Jupyter notebook."